...
class ValidationExceptionHandler(private val telegramApi: TelegramApi) : FormExceptionHandler<ValidationException>() {
    override fun handleException(message: TelegramMessage, state: FormState, exception: ValidationException) {
        telegramApi.sendMessage(exception.message)
    }
}
